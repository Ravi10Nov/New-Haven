...
export default function ViewCourses({ url }) {
  const { user } = useAuth();
  ...
  const fetchEnrolledCourses = async () => {
    ...
    const response = await axios.get(
      `${process.env.REACT_APP_BACKEND_URL}/api/courses/course/enrolled/${user._id}`
    );
            ...
            enrolledCourses.map((course) => (
              ...
              >
                ...
                <div className="flex items-center justify-end">
                  <Link to={`${url}/courses/enrolled/${course._id}/modules`}>
