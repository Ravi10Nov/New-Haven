...
// export const ViewWelcomeLetter = (
//   firstname,
//   spiritualname,
//   lastname,
//   certificateDate,
...
//   doc.text("Native American Church", 40, 29);
  ...
  //   doc.setFontSize(20);
  //   doc.setTextColor(0, 0, 255); // Set color to blue for more signature-like appearance
  //   doc.text("Man Found Standing", 15, 250);
...
export const ViewWelcomeLetter = (
  ...
  <div id="exemption-letter" style="line-height: 1.5;">
    ...
    <div style="margin-left: 3px; font-size: 12px; color: black;">
      ...
      <h4 style="font-size: 14px; margin: 0;">Dear ${firstname} '${spiritualname}' ${lastname}</h4>
      <br>
    </div>
