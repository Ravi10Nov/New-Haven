...
const ModuleCard = ({ module, index, handleUpdateButtonClick, handleDeleteButtonClick,url,courseId, handleModuleDelete,handleTitleUpdate,handleTitleUpdateChange,moduleDeleteModalOpen,moduleUpdateModalOpen,moduleUpdateTitle,setModuleUpdateModalOpen,setModuleDeleteModalOpen
}) => {
  return (
                ...
                >
                  <Box sx={style}>
                    ...
                    <div className="flex w-full justify-end items-center mt-3">
                      <Button style={{marginRight:'5px'}} variant="contained" onClick={handleTitleUpdate}>SAVE</Button>
                  ...
                  <Modal
                    ...
                    >
                      <Box sx={style}>
                        <Typography id="modal-modal-title" variant="h6" component="h2">
                        Are you sure you want to delete this chapter?  All the associated sections and PDF files will be deleted.
                        </Typography>
